...
def dashboard():
    ...
    # Load numeric (preprocessed) data for model input
    ...
    packet_scaled = scaler.fit_transform(packet_df_numeric)  # uses all numeric features including encoded protocol
