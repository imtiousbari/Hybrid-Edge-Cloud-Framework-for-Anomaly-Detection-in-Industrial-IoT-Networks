...
# Load your CSV file
df = pd.read_csv(os.path.join(folder_path, 'human_readable_packet_data_web.csv'))
...
split_path_70 = os.path.join(folder_path, 'human_preprocessed_packet_data_70_percent.csv')
df_70.to_csv(split_path_70, index=False)
print(f"[INFO] Preprocessed 70% data saved to: {split_path_70}")

split_path_30 = os.path.join(folder_path, 'human_preprocessed_packet_data_30_percent.csv')
