...
# Step 3: Save human-readable version
# df_human = df.copy()
# df_human[numeric_features] = scaler.inverse_transform(df_human[numeric_features])
# df_human['Protocol'] = le_protocol.inverse_transform(df_human['Protocol'].clip(0, len(le_protocol.classes_) - 1))
...
# df_human = df.copy()
# df_human[numeric_features] = scaler.inverse_transform(df_human[numeric_features])
# df_human[numeric_features] = df_human[numeric_features].round().astype(int)  # ✅ Integers now
